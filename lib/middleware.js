...
exports.process = function(req, rsp, next){
  ...
  fs.open = function(){
    ...
    opened_files.push(file_path)
    // mode = arguments[1]
    // console.log('File Open:', path, 'Mode', mode)
    _fs_open.apply(this, arguments)
  }

  req.poly.render(sourceFile, function(error, result){
    var body = null;
    ...
    if(error){
      ...
      cache.setCache(_results, opened_files)
