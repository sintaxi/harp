...
exports.buildPriorityList = function(fpath){
  ...
  // less
  else if(path.extname(fpath) == ".css"){
...
exports.outputFilename = function(source){
 ...
 *     }
 *     
 *     walkData(["foo", "bar", "baz"], globals) => "You Found Me!"
 */
...
var walkData = exports.walkData = function(tail, obj){
  ...
  var head = tail.shift()
  if(obj && obj.hasOwnProperty(head)){
    return obj[head]["data"] 
      ? obj[head]["data"][tail[0]]
      : walkData(tail, obj[head])
  }else{
    return null
  }
}
